...
//        console.log("Tyhjennä pressed!");
  ...
  //  });
    $("#searchBtn").click(function () {
        ...
        $.ajax({
            method: "GET",
            url: "http://localhost:3000/persons/name=" + text + "/username=" + sessionStorage.user,
        }).done(buildTable); 
   });
   ...
   // $("[data-dummy]").html("<p>Hello World</p>");
    ...
    var setting = {
        ...
        url: "http://localhost:3000/friends/username=" + sessionStorage['user'],
...
/* buildTable piirtää taulukon Person- tai User-collectionin datataulukosta */

function buildTable (data) {
        console.log("Taulukkoa pukkaa: " + data);
